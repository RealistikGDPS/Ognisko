...
from ognisko.services import ErrorOr
from ognisko.services import ServiceError
from ognisko.utilities.typing import SupportsStr
...
def unwrap[T](value: ErrorOr[T]) -> T:
    ...
    if isinstance(value, ServiceError):
        interrupt_with_error(_resolve_error_from_service_error(value))
